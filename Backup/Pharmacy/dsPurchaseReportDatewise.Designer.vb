...
<Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "2.0.0.0"),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("dsPurchaseReportDatewise"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class dsPurchaseReportDatewise
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As dsPurchaseReportDatewise = CType(MyBase.Clone,dsPurchaseReportDatewise)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "dsPurchaseReportDatewise"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/dsPurchaseReportDatewise.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As dsPurchaseReportDatewise = New dsPurchaseReportDatewise
    ...
    Partial Public Class InvoiceDetailsDataTable
        ...
        Public Overloads Function AddInvoiceDetailsRow( _
                    ...
                    ByVal InvoiceDt As Date) As InvoiceDetailsRow
            Dim rowInvoiceDetailsRow As InvoiceDetailsRow = CType(Me.NewRow,InvoiceDetailsRow)
            Dim columnValuesArray() As Object = New Object() {InvoiceNo, InvoiceDateTime, CompanyInvoiceNo, DoctorName, SupplierID, SNo, ProductName, Qty, BatchNo, ExpDate, VAT, MRP, HSR, Total, SupplierName, InvoiceDt}
    ...
    Partial Public Class InvoiceDetailsRow
        ...
        Public Function IsInvoiceDtNull() As Boolean
            Return Me.IsNull(Me.tableInvoiceDetails.InvoiceDtColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute()>  _
        Public Sub SetInvoiceDtNull()
            Me(Me.tableInvoiceDetails.InvoiceDtColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace dsPurchaseReportDatewiseTableAdapters
    ...
    Partial Public Class InvoiceDetailsTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT     InvoiceDetails.InvoiceNo, InvoiceDetails.InvoiceDateTime, InvoiceDetai"& _ 
                ...
                "                   InvoiceDetails.MRP, InvoiceDetails.HSR, InvoiceDetails.Total,"& _ 
                "InvoiceDetails.InvoiceDt,SupplierMaster.SupplierName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         InvoiceDetail"& _ 
                "s INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      SupplierMaster ON InvoiceDetails.SupplierID "& _ 
                "= SupplierMaster.SupplierID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (InvoiceDetails.InvoiceDt>@FromDate AND I"& _ 
                "nvoiceDetails.InvoiceDt<=@ToDate) and InvoiceDetails.Status<>'C' order by Invoic"& _ 
                "eDetails.InvoiceNo"
            ...
            Me._commandCollection(1).CommandText = "SELECT     InvoiceDetails.InvoiceNo, InvoiceDetails.InvoiceDateTime, InvoiceDetai"& _ 
                ...
                "s.Qty, InvoiceDetails.BatchNo, InvoiceDetails.ExpDate, InvoiceDetails.VAT, "&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"   "& _ 
                "                   InvoiceDetails.MRP, InvoiceDetails.HSR, InvoiceDetails.Total,"& _ 
                "InvoiceDetails.InvoiceDt, SupplierMaster.SupplierName"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM         InvoiceDetai"& _ 
                "ls INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      SupplierMaster ON InvoiceDetails.SupplierID"& _ 
                " = SupplierMaster.SupplierID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (InvoiceDetails.InvoiceDt>@FromDate AND "& _ 
                "InvoiceDetails.InvoiceDt<=@ToDate) and DoctorName=@DoctorName and InvoiceDetails"& _ 
                ".Status<>'C'  order by InvoiceDetails.InvoiceNo"
            ...
            Me._commandCollection(1).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@DoctorName", Global.System.Data.SqlDbType.VarChar, 50, Global.System.Data.ParameterDirection.Input, 0, 0, "DoctorName", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
            ...
            Me._commandCollection(2).CommandText = "SELECT     InvoiceDetails.InvoiceNo, InvoiceDetails.InvoiceDateTime, InvoiceDetai"& _ 
                ...
                "ls INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      SupplierMaster ON InvoiceDetails.SupplierID"& _ 
                " = SupplierMaster.SupplierID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (InvoiceDetails.InvoiceDt>@FromDate AND "& _ 
                "InvoiceDetails.InvoiceDt<=@ToDate) and InvoiceDetails.DoctorName=@DoctorName and"& _ 
                " InvoiceDetails.SupplierID=@SupplierID and InvoiceDetails.Status<>'C' order by I"& _ 
                "nvoiceDetails.InvoiceNo"
            ...
            Me._commandCollection(3).CommandText = "SELECT     InvoiceDetails.InvoiceNo, InvoiceDetails.InvoiceDateTime, InvoiceDetai"& _ 
                ...
                "ls INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"                      SupplierMaster ON InvoiceDetails.SupplierID"& _ 
                " = SupplierMaster.SupplierID"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE     (InvoiceDetails.InvoiceDt>@FromDate AND "& _ 
                "InvoiceDetails.InvoiceDt<=@ToDate) and InvoiceDetails.SupplierID=@SupplierID and"& _ 
                " InvoiceDetails.Status<>'C' order by InvoiceDetails.InvoiceNo"
            ...
            Me._commandCollection(3).Parameters.Add(New Global.System.Data.SqlClient.SqlParameter("@SupplierID", Global.System.Data.SqlDbType.[Decimal], 9, Global.System.Data.ParameterDirection.Input, 18, 0, "SupplierID", Global.System.Data.DataRowVersion.Current, false, Nothing, "", "", ""))
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As dsPurchaseReportDatewise.InvoiceDetailsDataTable, ByVal FromDate As Global.System.Nullable(Of Date), ByVal ToDate As Global.System.Nullable(Of Date)) As Integer
        ...
        Public Overloads Overridable Function GetData(ByVal FromDate As Global.System.Nullable(Of Date), ByVal ToDate As Global.System.Nullable(Of Date)) As dsPurchaseReportDatewise.InvoiceDetailsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (FromDate.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(FromDate.Value,Date)
            Else
            ...
            Else
                Me.Adapter.SelectCommand.Parameters(1).Value = Global.System.DBNull.Value
            End If
            Dim dataTable As dsPurchaseReportDatewise.InvoiceDetailsDataTable = New dsPurchaseReportDatewise.InvoiceDetailsDataTable
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As dsPurchaseReportDatewise.InvoiceDetailsDataTable, ByVal FromDate As Global.System.Nullable(Of Date), ByVal ToDate As Global.System.Nullable(Of Date), ByVal DoctorName As String) As Integer
        ...
        Public Overloads Overridable Function GetDataBy(ByVal FromDate As Global.System.Nullable(Of Date), ByVal ToDate As Global.System.Nullable(Of Date), ByVal DoctorName As String) As dsPurchaseReportDatewise.InvoiceDetailsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(1)
            If (FromDate.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(FromDate.Value,Date)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy1(ByVal dataTable As dsPurchaseReportDatewise.InvoiceDetailsDataTable, ByVal FromDate As Global.System.Nullable(Of Date), ByVal ToDate As Global.System.Nullable(Of Date), ByVal DoctorName As String, ByVal SupplierID As Global.System.Nullable(Of Decimal)) As Integer
            ...
            If (SupplierID.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(3).Value = CType(SupplierID.Value,Decimal)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy1(ByVal FromDate As Global.System.Nullable(Of Date), ByVal ToDate As Global.System.Nullable(Of Date), ByVal DoctorName As String, ByVal SupplierID As Global.System.Nullable(Of Decimal)) As dsPurchaseReportDatewise.InvoiceDetailsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(2)
            If (FromDate.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(FromDate.Value,Date)
            Else
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, false)>  _
        Public Overloads Overridable Function FillBy2(ByVal dataTable As dsPurchaseReportDatewise.InvoiceDetailsDataTable, ByVal FromDate As Global.System.Nullable(Of Date), ByVal ToDate As Global.System.Nullable(Of Date), ByVal SupplierID As Global.System.Nullable(Of Decimal)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], false)>  _
        Public Overloads Overridable Function GetDataBy2(ByVal FromDate As Global.System.Nullable(Of Date), ByVal ToDate As Global.System.Nullable(Of Date), ByVal SupplierID As Global.System.Nullable(Of Decimal)) As dsPurchaseReportDatewise.InvoiceDetailsDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(3)
            If (FromDate.HasValue = true) Then
                Me.Adapter.SelectCommand.Parameters(0).Value = CType(FromDate.Value,Date)
            Else
    ...
    Partial Public Class FromToDateTableTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As dsPurchaseReportDatewise.FromToDateTableDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As dsPurchaseReportDatewise.FromToDateTableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As dsPurchaseReportDatewise.FromToDateTableDataTable = New dsPurchaseReportDatewise.FromToDateTableDataTable
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As dsPurchaseReportDatewise.FromToDateTableDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As dsPurchaseReportDatewise) As Integer
